...
public final class TemplateFromYamlTool
{
  ...
  public static McpSchema.Tool tool()
  {
    ...
    properties.put("yaml", Map.of(
        "type", "string",
        "description",
        "CEDAR template described in the artifact library's YAML format. "
            + "Top-level keys include 'type: template', 'name', 'description', 'version', "
            + "'status', and 'children' (a list of field/element specifications). "
