 ...
 * attribute-value fields have no regular instance representation and are excluded —
 * the caller must check {@link FieldInputType#isStatic} / {@link FieldInputType#isAttributeValue}
 * and skip the schema child before reaching this helper.
 */
final class EmptyFieldInstances
{
   ...
   */
  static FieldInstanceArtifact emptyFor(FieldSchemaArtifact field)
  {
