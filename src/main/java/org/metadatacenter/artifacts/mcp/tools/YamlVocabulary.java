...
final class YamlVocabulary
{
  ...
  static final String INSTANCE_VOCABULARY = String.join("\n",
    ...
    "  <attribute-value field key>: an attribute-value field is its own top-level group BESIDE",
    "                   'children:', named with the template's field key — never nested under",
    "                   'children:'. Its value is a free-form map keyed by the user-chosen",
    "                   attribute names; each entry is literal-only and has the shape of a",
    "                   text-field instance (value, optionally language).",
    "",
