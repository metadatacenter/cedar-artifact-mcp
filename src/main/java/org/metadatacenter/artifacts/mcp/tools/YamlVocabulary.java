...
final class YamlVocabulary
{
  ...
  static final String FIELD_TYPES_AND_KEYS = String.join("\n",
    ...
    "                           default: numeric literal as a QUOTED STRING (e.g. '42', '3.14').",
    "                                    The datatype line is authoritative for the value's type;",
    "                                    a bare YAML number would lose that information through",
    "                                    YAML's auto-typing. The library accepts either form on",
    "                                    read but always emits quoted on render.",
    ...
    "                           - type: class      → iri, acronym, termType, termLabel, label",
    "                                                (and 'source' or 'sourceUri' for the ontology)",
    "                           - type: branch     → iri, acronym, ontologyName, termLabel, maxDepth?",
    "                           - type: ontology   → iri, acronym, ontologyName",
    "                           - type: valueSet   → iri, vsCollection, valueSetName, numTerms?",
